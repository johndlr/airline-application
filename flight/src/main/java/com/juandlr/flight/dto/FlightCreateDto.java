...
@Schema(
        name = "Flight",
        description = "Schema to hold new Flight information"
)
public class FlightCreateDto {

    @Schema(
            description = "Represents the airport of origin", example = "Chicago"
    )
    @NotEmpty(message = "Origin cannot be null or empty")
    private String origin;

    @Schema(
            description = "Represents the airport of destination", example = "Miami"
    )
