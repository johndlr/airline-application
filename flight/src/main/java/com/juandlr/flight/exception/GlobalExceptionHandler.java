...
import com.juandlr.flight.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleGlobalException(AircraftTypeNotFoundException exception,WebRequest webRequest) {
        return new ResponseEntity<>(errorResponseDtoGenerator(exception,webRequest), HttpStatus.INTERNAL_SERVER_ERROR);
    }

    @ExceptionHandler(FlightAlreadyExistsException.class)
    public ResponseEntity<ErrorResponseDto> handleGlobalException(FlightAlreadyExistsException exception,WebRequest webRequest) {
        return new ResponseEntity<>(errorResponseDtoGenerator(exception,webRequest), HttpStatus.INTERNAL_SERVER_ERROR);
    }
