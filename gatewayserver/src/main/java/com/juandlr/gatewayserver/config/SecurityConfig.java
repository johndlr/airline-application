package com.juandlr.gatewayserver.config;
    ...
    public SecurityWebFilterChain securityFilterChain(ServerHttpSecurity serverHttpSecurity){
        serverHttpSecurity.authorizeExchange(authorizeExchangeSpec ->
                authorizeExchangeSpec.pathMatchers(HttpMethod.GET).permitAll()
                        .pathMatchers("/airline/reservation/**").hasRole("RESERVATION")
                        .pathMatchers("/airline/customer/**").hasRole("CUSTOMER")
                        .pathMatchers("/airline/flight/**").hasRole("FLIGHT"))
